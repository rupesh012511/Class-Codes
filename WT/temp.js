...
function sumNumbers(...nums) {
  ...
  // Using rest operator to gather numbers and return their sum
  let sum = 0;
  for (const n of nums) {
    sum += n;
  }
...
function mergeArrays(arr1, arr2) {
  // STUDENT CODE STARTS HERE
  // Use spread operator to concatenate arrays into a new array
  return [...arr1, ...arr2];
  // STUDENT CODE ENDS HERE
}
...
function updateObject(obj, newKey, newValue) {
  // STUDENT CODE STARTS HERE
  // Create copy using spread and add new key/value
...
function findMax(arr) {
  // STUDENT CODE STARTS HERE
  // Use spread to pass array elements to Math.max
  return Math.max(...arr);
  // STUDENT CODE ENDS HERE
}
...
function formatStudent(obj) {
  // STUDENT CODE STARTS HERE
  // Object destructuring and template literal
